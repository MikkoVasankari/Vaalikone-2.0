...
public class ehdokkaat {
	...
	public ehdokkaat(String id, String etunimi, String ehdokas_num, String kotipaikkakunta, int ika, String ammatti, String kommentti) {
    ...
    public ehdokkaat(int id , int tulos) {
		this.id = id;
		this.tulos = tulos;
	}
    public ehdokkaat() {
    ...
    //TÄMÄ ON LISÄYS POISTA TARVITTAESSA
    public ehdokkaat(String id, String nimi) {
		// TODO Auto-generated constructor stub
	}
